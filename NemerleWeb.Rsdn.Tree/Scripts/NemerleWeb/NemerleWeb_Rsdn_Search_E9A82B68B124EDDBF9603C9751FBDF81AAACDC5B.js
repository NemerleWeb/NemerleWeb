  ...
  NemerleWeb_Rsdn_Search$ctor[""] = function() {
    ...
    var _N_initializedObject_18544_18545 = new NemerleWeb_Rsdn_TreeNode("");
    _N_initializedObject_18544_18545.set_Children([]);
    _N_T_temp_var_18 = _N_initializedObject_18544_18545;
    _nw_self.SearchResultsForums = _N_T_temp_var_18;
    var _N_T_temp_var_19;
    var _N_initializedObject_18546_18547 = new NemerleWeb_Rsdn_TreeNode("");
    _N_initializedObject_18546_18547.set_Children([]);
    _N_T_temp_var_19 = _N_initializedObject_18546_18547;
    _nw_self.SearchResultsArticles = _N_T_temp_var_19;
    var _N_T_temp_var_20;
    var _N_initializedObject_18548_18549 = new NemerleWeb_Rsdn_TreeNode("");
    _N_initializedObject_18548_18549.set_Children([]);
    _N_T_temp_var_20 = _N_initializedObject_18548_18549;
  ...
  function NemerleWeb_Rsdn_Search() {
    ...
    _nw_self.set_SearchTerm = _nw_self.set_SearchTerm$$= function(value) {
      var _nw_self = this;
      window.clearTimeout(_nw_self._timeoutVar18495);
      _nw_self._timeoutVar18495 = window.setTimeout(function () {   if((_nw_self._searchTerm !== value)) { 
  ...
  nweb.invalidate() }, 500, null)
    ...
    _nw_self.Search["System.String"] = _nw_self.Search$$["System.String"] = function(term) {
      ...
      if(!((((term === null) || (typeof term === "undefined")) || (term === "")))) { 
        var _N_wildcard_3547_18787 = $.ajax({
  url: '/Search/Search',
  type: 'POST',
  dataType: 'json',
  ...
  success: function(result) {
    ...
    var callback = function (nodes) {   var _N_wildcard_3547_18559 = console.log(nodes.length);
  var cached_collection_18780 = nodes;
  var index_18781 = 0;
  var loop_18784 = function () {   var _N_T_temp_var_24 = "__lbl__15";
  __gotoSwitchLoop: while(true) {

    switch(_N_T_temp_var_24) {
      case "__lbl__15":
        if((index_18781 < cached_collection_18780.length)) { 
      ...
      break;
      case "__lbl__13":
        node_18786 = cached_collection_18780[index_18781];
        var _N_T_temp_var_23 = node_18786.get_Icon();
      ...
      break;
      case "__lbl__10":
        var _N_T_temp_var_22 = node_18786.get_Icon();
      ...
      break;
      case "__lbl__8":
        var _N_T_temp_var_21 = node_18786.get_Icon();
      ...
      break;
      case "__lbl__6":
        _nw_self.SearchResultsOthers.get_Children().push(node_18786);
        _N_T_temp_var_24 = "__lbl__2";
        continue __gotoSwitchLoop
      break;
      case "__lbl__5":
      ...
      break;
      case "__lbl__4":
        _nw_self.SearchResultsArticles.get_Children().push(node_18786);
        _N_T_temp_var_24 = "__lbl__2";
        continue __gotoSwitchLoop
      break;
      case "__lbl__3":
        _nw_self.SearchResultsForums.get_Children().push(node_18786);
        _N_T_temp_var_24 = "__lbl__2";
        continue __gotoSwitchLoop
      break;
      case "__lbl__2":
        index_18781 = ++(index_18781);
        loop_18784();
        break __gotoSwitchLoop;
      break;
    default:
