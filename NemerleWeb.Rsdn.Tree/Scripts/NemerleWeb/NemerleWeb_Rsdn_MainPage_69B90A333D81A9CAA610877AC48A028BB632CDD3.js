  ...
  NemerleWeb_Rsdn_MainPage$ctor[""] = function() {
    ...
    var _N_wildcard_3547_17795 = $.ajax({
  ...
  var _N_T_temp_var_5;
  var _N_initializedObject_17785_17786 = new NemerleWeb_Rsdn_TreeNode("");
  _N_initializedObject_17785_17786.set_Children(nodes);
  _N_T_temp_var_5 = _N_initializedObject_17785_17786;
  _nw_self.set_Root(_N_T_temp_var_5) };
    ...
    var _N_wildcard_3547_17814 = $.ajax({
  ...
  success: function(result) {
    var typed = nweb.utils.toTypedObject(result);
    var callback = function (nodes) {   var pinned_17801 = _nw_self.get_Pinned().GetPinned[""].call(_nw_self.get_Pinned());
  var _N_T_temp_var_6;
  var _N_initializedObject_17802_17803 = new NemerleWeb_Rsdn_TreeNode("");
  _N_initializedObject_17802_17803.set_Children(Enumerable.from(nodes).where(function (n) {   return !(Enumerable.from(pinned_17801).any(function (p) {   return (p !== n.get_Id()) })) }));
  _N_T_temp_var_6 = _N_initializedObject_17802_17803;
  ...
  function NemerleWeb_Rsdn_MainPage() {
    ...
    _nw_self.SelectNode["NemerleWeb.Rsdn.TreeNode"] = _nw_self.SelectNode$$["NemerleWeb.Rsdn.TreeNode"] = function(node) {
      ...
      var getAllParents_17877 = function (node) {   var _nw_returnValue;
  ...
  if((_N_T_temp_var_7 && (typeof node.get_Parent() !== "undefined"))) { 
    _nw_returnValue = [node.get_Parent()].concat(getAllParents_17877(node.get_Parent()))
  } else {
    _nw_returnValue = []
  };
  return _nw_returnValue };
      _nw_self.set_SelectedNode(node);
      _nw_self.set_ActiveNodes([node].concat(getAllParents_17877(node)));
    ...
    _nw_self.IsActiveNode["NemerleWeb.Rsdn.TreeNode"] = _nw_self.IsActiveNode$$["NemerleWeb.Rsdn.TreeNode"] = function(node) {
      ...
      var _nw_returnValue;
      var e1_17904 = _nw_self.get_ActiveNodes();
      var result_17905 = false;
      var _N_T_temp_var_8 = (e1_17904 !== null);
      if((_N_T_temp_var_8 && (typeof e1_17904 !== "undefined"))) { 
        result_17905 = Enumerable.from(e1_17904).any(function (n) {   return (n.get_Id() === node.get_Id()) })
      } else {

      };
      _nw_returnValue = result_17905;
      return _nw_returnValue
    }
