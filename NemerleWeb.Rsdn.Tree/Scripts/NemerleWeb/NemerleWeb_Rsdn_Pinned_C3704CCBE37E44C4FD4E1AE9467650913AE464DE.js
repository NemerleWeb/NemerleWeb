  ...
  function NemerleWeb_Rsdn_Pinned() {
    ...
    _nw_self.UpdatePinned[""] = _nw_self.UpdatePinned$$[""] = function() {
      ...
      var _N_wildcard_3547_18323 = $.ajax({
  ...
  success: function(result) {
    ...
    _nw_self.AddPinned["System.String"] = _nw_self.AddPinned$$["System.String"] = function(id) {
      ...
      var _N_T_temp_var_12 = (pinned_18353 === null);
      if((_N_T_temp_var_12 || (typeof pinned_18353 === "undefined"))) { 
        nweb.setCookie("pinned", id, 360)
      } else {
        nweb.setCookie("pinned", pinned_18353.concat(",").toString().concat(id), 360)
      };
      _nw_self.UpdatePinned[""].call(_nw_self)
    }
    ...
    _nw_self.RemovePinned["System.String"] = _nw_self.RemovePinned$$["System.String"] = function(id) {
      ...
      _nw_self._cookieCache = null;
      var pinned_18364 = nweb.getCookie("pinned");
      var _N_T_temp_var_13 = (pinned_18364 !== null);
      if((_N_T_temp_var_13 && (typeof pinned_18364 !== "undefined"))) { 
        nweb.setCookie("pinned", pinned_18364.replace(RegExp(",?".concat(id), "g"), ""), 360)
      } else {
    ...
    _nw_self.GetPinned[""] = _nw_self.GetPinned$$[""] = function() {
      ...
      if((_N_T_temp_var_14 && (typeof _nw_self._cookieCache !== "undefined"))) { 
        pinnedStr_18426 = _nw_self._cookieCache
      } else {
        pinnedStr_18426 = nweb.getCookie("pinned")
      };
      var _N_T_temp_var_15 = (pinnedStr_18426 === null);
      if((_N_T_temp_var_15 || (typeof pinnedStr_18426 === "undefined"))) { 
        _nw_returnValue = []
      } else {
        str_18427 = pinnedStr_18426;
        _nw_returnValue = str_18427.split([","])
      };
