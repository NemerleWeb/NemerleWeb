  ...
  function NemerleWeb_Rsdn_TreeNode() {
    ...
    _nw_self.get_IconUrl = _nw_self.get_IconUrl$$= function() {
      ...
      _nw_returnValue = "http://rsdn.ru/images/tree/".concat(_nw_self.get_Icon()).toString().concat(suffix_18978);
    ...
    _nw_self.CaptionClick[""] = _nw_self.CaptionClick$$[""] = function() {
      ...
      if(_nw_self.get_HasChildren()) { 
        ...
        if((_N_T_temp_var_29 || (typeof _nw_self.get_Children() === "undefined"))) { 
          ...
          var _N_wildcard_3547_19023 = $.ajax({
  ...
  var enumerator_19015 = _nw_self.get_Children().getEnumerator();
  var loop_19018 = function () {   if(enumerator_19015.moveNext()) { 
    child_19020 = enumerator_19015.current();
    child_19020.set_Parent(_nw_self);
    loop_19018()
  } else {
  ...
  try {
    ...
    if((enumerator_19015.dispose && (typeof enumerator_19015.dispose === "function"))) { 
      enumerator_19015.dispose()
    } else {
      enumerator_19015.Dispose[""]()
    }
  }
  ...
  _nw_self.set_IsLoading(false) };
    ...
    nweb.invalidate();
        ...
        if(window.event.ctrlKey) { 
          var _N_wildcard_3547_19567 = window.open(_nw_self.get_Href(), "_blank", null, false)
        } else {
