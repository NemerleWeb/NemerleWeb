  ...
  function NemerleWeb_Rsdn_Pinned() {
    ...
    _nw_self.get_Node = _nw_self.get_Node$$= function() {
      var _nw_self = this;
      return _nw_self._N_Node_8255
    };
    _nw_self.set_Node = _nw_self.set_Node$$= function(value) {
      var _nw_self = this;
      _nw_self._N_Node_8255 = value
    };
    ...
    _nw_self.UpdatePinned[""] = _nw_self.UpdatePinned$$[""] = function() {
      ...
      var _N_wildcard_3547_18312 = $.ajax({
  ...
  success: function(result) {
    ...
    _nw_self.AddPinned["System.String"] = _nw_self.AddPinned$$["System.String"] = function(id) {
      ...
      var pinned_18342 = nweb.getCookie("pinned");
      var _N_T_temp_var_12 = (pinned_18342 === null);
      if((_N_T_temp_var_12 || (typeof pinned_18342 === "undefined"))) { 
        nweb.setCookie("pinned", id, 360)
      } else {
        nweb.setCookie("pinned", pinned_18342.concat(",").toString().concat(id), 360)
      };
      _nw_self.UpdatePinned[""].call(_nw_self)
    }
    ...
    _nw_self.RemovePinned["System.String"] = _nw_self.RemovePinned$$["System.String"] = function(id) {
      ...
      _nw_self._cookieCache = null;
      var pinned_18353 = nweb.getCookie("pinned");
      var _N_T_temp_var_13 = (pinned_18353 !== null);
      if((_N_T_temp_var_13 && (typeof pinned_18353 !== "undefined"))) { 
        nweb.setCookie("pinned", pinned_18353.replace(RegExp(",?".concat(id), "g"), ""), 360)
      } else {
    ...
    _nw_self.GetPinned[""] = _nw_self.GetPinned$$[""] = function() {
      ...
      if((_N_T_temp_var_14 && (typeof _nw_self._cookieCache !== "undefined"))) { 
        pinnedStr_18415 = _nw_self._cookieCache
      } else {
        pinnedStr_18415 = nweb.getCookie("pinned")
      };
      var _N_T_temp_var_15 = (pinnedStr_18415 === null);
      if((_N_T_temp_var_15 || (typeof pinnedStr_18415 === "undefined"))) { 
        _nw_returnValue = []
      } else {
        str_18416 = pinnedStr_18415;
        _nw_returnValue = str_18416.split([","])
      };
...
///SignalR///
    _nw_self.__nweb_meta = {
      ...
      fields:     [{ name: "_cookieCache", attrs: [''], ValueType: false },{ name: "_N_Node_8255", attrs: ['System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)','System.Runtime.CompilerServices.CompilerGenerated'], ValueType: false }],
      methods:    []
    };
