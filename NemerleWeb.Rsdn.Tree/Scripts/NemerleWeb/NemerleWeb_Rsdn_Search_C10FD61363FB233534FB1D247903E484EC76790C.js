  ...
  NemerleWeb_Rsdn_Search$ctor[""] = function() {
    ...
    var _N_initializedObject_18549_18550 = new NemerleWeb_Rsdn_TreeNode("");
    _N_initializedObject_18549_18550.set_Children([]);
    _N_T_temp_var_18 = _N_initializedObject_18549_18550;
    _nw_self.SearchResultsForums = _N_T_temp_var_18;
    var _N_T_temp_var_19;
    var _N_initializedObject_18551_18552 = new NemerleWeb_Rsdn_TreeNode("");
    _N_initializedObject_18551_18552.set_Children([]);
    _N_T_temp_var_19 = _N_initializedObject_18551_18552;
    _nw_self.SearchResultsArticles = _N_T_temp_var_19;
    var _N_T_temp_var_20;
    var _N_initializedObject_18553_18554 = new NemerleWeb_Rsdn_TreeNode("");
    _N_initializedObject_18553_18554.set_Children([]);
    _N_T_temp_var_20 = _N_initializedObject_18553_18554;
  ...
  function NemerleWeb_Rsdn_Search() {
    ...
    _nw_self.set_SearchTerm = _nw_self.set_SearchTerm$$= function(value) {
      var _nw_self = this;
      window.clearTimeout(_nw_self._timeoutVar18500);
      _nw_self._timeoutVar18500 = window.setTimeout(function () {   if((_nw_self._searchTerm !== value)) { 
  ...
  nweb.invalidate() }, 500, null)
    ...
    _nw_self.Search["System.String"] = _nw_self.Search$$["System.String"] = function(term) {
      ...
      if(!((((term === null) || (typeof term === "undefined")) || (term === "")))) { 
        var _N_wildcard_3547_18792 = $.ajax({
  url: '/Search/Search',
  type: 'POST',
  dataType: 'json',
  ...
  success: function(result) {
    ...
    var callback = function (nodes) {   var _N_wildcard_3547_18564 = console.log(nodes.length);
  var cached_collection_18785 = nodes;
  var index_18786 = 0;
  var loop_18789 = function () {   var _N_T_temp_var_24 = "__lbl__15";
  __gotoSwitchLoop: while(true) {

    switch(_N_T_temp_var_24) {
      case "__lbl__15":
        if((index_18786 < cached_collection_18785.length)) { 
      ...
      break;
      case "__lbl__13":
        node_18791 = cached_collection_18785[index_18786];
        var _N_T_temp_var_23 = node_18791.get_Icon();
      ...
      break;
      case "__lbl__10":
        var _N_T_temp_var_22 = node_18791.get_Icon();
      ...
      break;
      case "__lbl__8":
        var _N_T_temp_var_21 = node_18791.get_Icon();
      ...
      break;
      case "__lbl__6":
        _nw_self.SearchResultsOthers.get_Children().push(node_18791);
        _N_T_temp_var_24 = "__lbl__2";
        continue __gotoSwitchLoop
      break;
      case "__lbl__5":
      ...
      break;
      case "__lbl__4":
        _nw_self.SearchResultsArticles.get_Children().push(node_18791);
        _N_T_temp_var_24 = "__lbl__2";
        continue __gotoSwitchLoop
      break;
      case "__lbl__3":
        _nw_self.SearchResultsForums.get_Children().push(node_18791);
        _N_T_temp_var_24 = "__lbl__2";
        continue __gotoSwitchLoop
      break;
      case "__lbl__2":
        index_18786 = ++(index_18786);
        loop_18789();
        break __gotoSwitchLoop;
      break;
    default:
