...
function Nemerle_Core_Some_$T$_(val) {
  this.val = val;
...
function Nemerle_Core_None_$T$_() {
  this._N_GetVariantCode = function () {
    return 0;
  };
}

Nemerle_Core_None_$T$_._N_constant_object = new Nemerle_Core_None_$T$_();

function Nemerle_Core_option_$T$_(val) {
  this.val = val;
}

Nemerle_Core_option_$T$_.prototype.HasValue = function() {
  return this.constructor == Nemerle_Core_Some_$T$_;
};
Nemerle_Core_Some_$T$_.prototype.HasValue = Nemerle_Core_option_$T$_.prototype.HasValue;
Nemerle_Core_None_$T$_.prototype.HasValue = Nemerle_Core_option_$T$_.prototype.HasValue;

Nemerle_Core_option_$T$_.prototype.IsSome = function () {
  return this.constructor == Nemerle_Core_Some_$T$_;
};
Nemerle_Core_Some_$T$_.prototype.IsSome = Nemerle_Core_option_$T$_.prototype.IsSome;
Nemerle_Core_None_$T$_.prototype.IsSome = Nemerle_Core_option_$T$_.prototype.IsSome;

Nemerle_Core_option_$T$_.prototype.IsNone = function () {
  return this == Nemerle_Core_None_$T$_._N_constant_object;
};
Nemerle_Core_Some_$T$_.prototype.IsNone = Nemerle_Core_option_$T$_.prototype.IsNone;
Nemerle_Core_None_$T$_.prototype.IsNone = Nemerle_Core_option_$T$_.prototype.IsNone;

Nemerle_Core_option_$T$_.prototype.Value = function () {
  if (this.IsSome())
    return this.val;
  if (this.IsNone())
...
Nemerle_Core_Some_$T$_.prototype.Value = Nemerle_Core_option_$T$_.prototype.Value;
Nemerle_Core_None_$T$_.prototype.Value = Nemerle_Core_option_$T$_.prototype.Value;